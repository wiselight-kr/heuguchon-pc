...
#!define MUI_ICON   "%%SOURCE%%\installers\windows\heuguchon_icon_os.ico"
#!define MUI_UNICON "%%SOURCE%%\installers\windows\heuguchon_icon_os.ico"
!define MUI_ICON   "%%SOURCE%%\installers\windows\heuguchon_icon${ICON_SUFFIX}.ico"
!define MUI_UNICON "%%SOURCE%%\installers\windows\heuguchon_icon${ICON_SUFFIX}.ico"
# </FS:Ansariel>
...
WriteRegStr SHELL_CONTEXT "${MSUNINSTALL_KEY}" "HelpLink" "https://www.heuguchon.com/support"
